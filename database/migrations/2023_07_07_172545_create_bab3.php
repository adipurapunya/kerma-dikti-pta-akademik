...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('bab3', function (Blueprint $table) {
            ...
            $table->string('deskripsi_singkat_kesiapan_sdm_pt')->nullable();
            $table->string('deskripsi_singkat_kesiapan_sdm_mitra')->nullable();
            ...
            $table->string('deskripsi_singkat_pt')->nullable();
            $table->string('deskripsi_singkat_mitra')->nullable();
